...
namespace GlobalGames.Migrations
{
    ...
    [Migration("20210113013249_fotos")]
    partial class fotos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GlobalGames.Data.Entidades.User", b =>
                {
            ...
            modelBuilder.Entity("GlobalGames.Data.Entidades.Inscricoes", b =>
                {
                    b.HasOne("GlobalGames.Data.Entidades.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GlobalGames.Data.Entidades.User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
