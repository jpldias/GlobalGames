...
namespace GlobalGames.Controllers
{
    public class ContactosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,LastName,Address,Email,msg")] Contactos contactos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,LastName,Address,Email,msg")] Contactos contactos)
        {
            if (id != contactos.Id)
            {
                return NotFound();
